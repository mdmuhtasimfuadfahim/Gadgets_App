...
function addToCart() {
  ...
  function updateCart(electro) {
    axios__WEBPACK_IMPORTED_MODULE_0___default().post('/upate-cart', electro).then(function (res) {
      // console.log(res)
  ...
  addToCart.forEach(function (btn) {
    ...
    btn.addEventListener('click', function (e) {
      // console.log(e)
      var electro = JSON.parse(btn.dataset.electro);
      updateCart(electro); // console.log(electro)
    });
  });
}
...
/* harmony import */ var _product__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./product */ "./resources/js/product.js");
/* harmony import */ var _slider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./slider */ "./resources/js/slider.js");
/* harmony import */ var _addToCart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./addToCart */ "./resources/js/addToCart.js");
/* harmony import */ var _deleteCartOperation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./deleteCartOperation */ "./resources/js/deleteCartOperation.js");
/* harmony import */ var _updateCustomerProfile__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./updateCustomerProfile */ "./resources/js/updateCustomerProfile.js");
...
(0,_product__WEBPACK_IMPORTED_MODULE_1__.productFunction)();
/*
====================
...
(0,_slider__WEBPACK_IMPORTED_MODULE_2__.sliderFunction)();
/*
=========================
...
(0,_addToCart__WEBPACK_IMPORTED_MODULE_3__.addToCart)();
/*--------- Remove Alert---------*/
...
(0,_deleteCartOperation__WEBPACK_IMPORTED_MODULE_4__.updateDeleteOperation)();
/*
=====================================
...
(0,_updateCustomerProfile__WEBPACK_IMPORTED_MODULE_5__.updateCustomerProfile)(); // /*---------socket operation (real time)--------*/ 
// let socket = io() 
...
/***/ "./resources/js/deleteCartOperation.js":
/*!*********************************************!*\
  !*** ./resources/js/deleteCartOperation.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "updateDeleteOperation": () => (/* binding */ updateDeleteOperation)
/* harmony export */ });
function updateDeleteOperation() {
  /*
  ================
  Delete Operation
  ================
  */
  if (window.location.pathname == "/cart") {
    ...
    $ondelete.click(function () {
      ...
      var request = {
        "url": "http://localhost:5000/cart/delete/".concat(id),
        "method": "DELETE"
      };
  ...
  */
  ...
  if (window.location.pathname) {
    ...
    $onupdate.click(function () {
      ...
      console.log(id);
      var request = {
        "url": "http://localhost:5000/cart/update/minus/".concat(id),
        "method": "PUT"
      };
      $.ajax(request).done(function (response) {
        location.reload();
  ...
  $onplus.click(function () {
    ...
    console.log(id);
    var request = {
      "url": "http://localhost:5000/cart/update/plus/".concat(id),
      "method": "PUT"
    };
    $.ajax(request).done(function (response) {
      location.reload();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "productFunction": () => (/* binding */ productFunction)
/* harmony export */ });
...
// const test = require('../../data/products.json')
function productFunction() {
  ...
  =============
   */
  var categoryCenter = document.querySelector(".category__center"); // window.addEventListener("DOMContentLoaded", async function () {
  ...
  var allCategoryPosts = document.querySelectorAll(".All_Products");
  var categoryTitle = document.querySelectorAll(".section__title");

  if (categoryContainer) {
    categoryContainer.addEventListener("click", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(e) {
        var target, i, filterPosts, changeActivePosition, id;
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                changeActivePosition = function _changeActivePosition(activeItem) {
                  for (var _i2 = 0; _i2 < categoryTitle.length; _i2++) {
                    categoryTitle[_i2].classList.remove('active');
                  }

                  activeItem.classList.add('active');
                };

                filterPosts = function _filterPosts(item) {
                  changeActivePosition(item);

                  for (var _i = 0; _i < allCategoryPosts.length; _i++) {
                    if (allCategoryPosts[_i].classList.contains(item.attributes.id.value)) {
                      allCategoryPosts[_i].style.display = "block";
                    } else {
                      allCategoryPosts[_i].style.display = "none";
                    }
                  }
                };
              ...
              case 5:
                for (i = 0; i < categoryTitle.length; i++) {
                  categoryTitle[i].addEventListener('click', filterPosts.bind(_this, categoryTitle[i]));
                }

                ;
                id = target.dataset.id; // const products = await getProducts();
                // if (id) {
  ...
  ["mouseover", "touchstart"].forEach(function (event) {
    if (picContainer) {
      picContainer.addEventListener(event, function (e) {
        ...
        changeImage("/img/products/iPhone/iphone".concat(id, ".jpeg"), id);
      });
    }
  }); // change active image
...
/***/ "./resources/js/updateCustomerProfile.js":
/*!***********************************************!*\
  !*** ./resources/js/updateCustomerProfile.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "updateCustomerProfile": () => (/* binding */ updateCustomerProfile)
/* harmony export */ });
function updateCustomerProfile() {
  ...
  $("#update_form").submit(function (event) {
    ...
    var request = {
      "url": "http://localhost:5000/customer/edit/".concat(data.id),
      "method": "PUT",
      "data": data
    };
    $.ajax(request).done(function (response) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmuhtasim0x"] = self["webpackChunkmuhtasim0x"] || [];
